...
public class EmployeeDataManager {
    ...
    //Used to login an employee to the program. Checks i their details are in the database
    ...
    //Used to login an admin to the program. Checks i their details are in the database
